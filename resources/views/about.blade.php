<x-layout>
    ...
    <div class="bg-white">
        ...
        <div class="mx-auto grid max-w-2xl grid-cols-1 items-center gap-x-8 gap-y-16 px-4 py-8 sm:px-6 sm:py-8 lg:max-w-7xl lg:grid-cols-2 lg:px-8">
          <div>
            ...
            <dl class="mt-16 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 sm:gap-y-16 lg:gap-x-8">
              <div class="border-t border-gray-200 pt-4">
                ...
                <dd class="mt-2 text-sm text-gray-500">
                  Ns. Arena Lestari, M.Kep., Sp.Kep.J., Ph.D 
                </dd>
              </div>
              <div class="border-t border-gray-200 pt-4">
                <dt class="font-medium text-gray-900">Pengarah</dt>
                <dd class="mt-2 text-sm text-gray-500">
                  Ns. Gunawan Irianto, M.Kep., Sp.Kep.Kom., Ph.D <br> <br>
                  Ns. Asri Rahmawati, M.Kes. <br> <br>
                  Afrizal, S.H.I., M.H.I. <br> <br>
                  Dr. Sofwan Adi Putra, M.Pd. Kons
                </dd>
              </div>
              <div class="border-t border-gray-200 pt-4">
                <dt class="font-medium text-gray-900">Ketua</dt>
                <dd class="mt-2 text-sm text-gray-500">
                  Arum Arupi Kusnindar, S.E., M.B.A
                </dd>
              </div>
              <div class="border-t border-gray-200 pt-4">
                <dt class="font-medium text-gray-900">Sekretaris</dt>
                <dd class="mt-2 text-sm text-gray-500">
                  Dewi Rahmawati, S.E
                </dd>
              </div>
              <div class="border-t border-gray-200 pt-4">
                <dt class="font-medium text-gray-900">Divisi Akademik</dt>
                <dd class="mt-2 text-sm text-gray-500">
                  Ainur Rosidah, S.Pd., M.Pd
                </dd>
              </div>
              <div class="border-t border-gray-200 pt-4">
                <dt class="font-medium text-gray-900">Divisi Non Akademik</dt>
                <dd class="mt-2 text-sm text-gray-500">
                  Astoni Nurdin, S.Pd., M.Pd
                </dd>
              </div>
            </dl>
          </div>
  ...
  class="relative isolate px-6 py-24 sm:py-32 lg:px-8 bg-white bg-cover bg-center w-full bg-[url('@{{ asset('/images/rektoratUmpri.jpg') }}')]">
    ...
    <div class="mx-auto max-w-4xl text-center">
      <p class="mt-2 text-balance text-5xl font-semibold tracking-tight text-gray-900 sm:text-6xl">Visi dan Misi</p>
    </div>
    <p class="mx-auto mt-6 max-w-2xl text-pretty text-center text-lg font-medium text-gray-500 sm:text-xl/8">
      "Memberikan Akses, Menciptakan Peluang, dan Mewujudkan Kehidupan yang Lebih Inklusif bagi Semua"        
    </p>
    ...
    <div class="mx-auto mt-16 grid max-w-lg grid-cols-1 items-center gap-y-6 sm:mt-20 sm:gap-y-0 lg:max-w-4xl lg:grid-cols-2">
      <div class="rounded-3xl rounded-t-3xl bg-white/60 p-8 ring-1 ring-gray-900/10 sm:mx-8 sm:rounded-b-none sm:p-10 lg:mx-0 lg:rounded-bl-3xl lg:rounded-tr-none">            
        <p class="mt-4 flex items-baseline gap-x-2">
          <span class="text-3xl font-semibold tracking-tight text-gray-900">Visi</span>
        </p>
        <ul role="list" class="mt-8 space-y-3 text-sm/6 text-gray-600 sm:mt-10">
          <li class="flex gap-x-3">
            ...
            Terwujudnya Unit Layanan Disabilitas yang unggul, Islami, dinamis, dan berorientasi global dalam mendukung pendidikan inklusi dan kesetaraan pada tahun 2035
          </li>
        </ul>
      </div>

      <div class="relative rounded-3xl bg-gray-700 p-8 ring-1 ring-gray-900/10 sm:p-10 lg:rounded-b-none">
        <p class="mt-4 flex items-baseline gap-x-2">
          <span class="text-3xl font-semibold tracking-tight text-white">Misi</span>
        </p>
        <ul role="list" class="mt-8 space-y-3 text-sm/6 text-gray-300 sm:mt-10">
          <li class="flex gap-x-3">
            ...
            Melaksanakan Layanan Pendidikan Inklusi yang adaptif
          </li>
          <li class="flex gap-x-3">
            <svg class="h-6 w-5 flex-none text-indigo-400" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true" data-slot="icon">
              <path fill-rule="evenodd" d="M16.704 4.153a.75.75 0 0 1 .143 1.052l-8 10.5a.75.75 0 0 1-1.127.075l-4.5-4.5a.75.75 0 0 1 1.06-1.06l3.894 3.893 7.48-9.817a.75.75 0 0 1 1.05-.143Z" clip-rule="evenodd" />
            </svg>
            Mendukung Kemandirian Penyandang Disabilitas melalui technopreneurship
          </li>
          <li class="flex gap-x-3">
            <svg class="h-6 w-5 flex-none text-indigo-400" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true" data-slot="icon">
              <path fill-rule="evenodd" d="M16.704 4.153a.75.75 0 0 1 .143 1.052l-8 10.5a.75.75 0 0 1-1.127.075l-4.5-4.5a.75.75 0 0 1 1.06-1.06l3.894 3.893 7.48-9.817a.75.75 0 0 1 1.05-.143Z" clip-rule="evenodd" />
            </svg>
            Melaksanakan layanan berkualitas yang Islami, inklusif dan berkemajuan kepada penyandang disabilitas
          </li>
          <li class="flex gap-x-3">
            <svg class="h-6 w-5 flex-none text-indigo-400" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true" data-slot="icon">
              <path fill-rule="evenodd" d="M16.704 4.153a.75.75 0 0 1 .143 1.052l-8 10.5a.75.75 0 0 1-1.127.075l-4.5-4.5a.75.75 0 0 1 1.06-1.06l3.894 3.893 7.48-9.817a.75.75 0 0 1 1.05-.143Z" clip-rule="evenodd" />
            </svg>
            Melaksanakan Kerjasama dengan berbagai pihak untuk meningkatkan kualitas layanan disabilitas
          </li>
        </ul>
      </div>

      <div class="lg:col-span-2 md:col-span-1 rounded-3xl rounded-t-3xl bg-gray-200/60 p-8 ring-1 ring-gray-900/10 sm:mx-8 sm:rounded-b-3xls sm:p-10 lg:mx-0 lg:rounded-bl-3xl lg:rounded-tr-none">
        <p class="mt-4 flex items-baseline gap-x-2">
          <span class="text-3xl font-semibold tracking-tight text-gray-900">Tujuan</span>
        </p>
        <ul role="list" class="mt-8 space-y-3 text-sm/6 text-gray-600 sm:mt-10">
          <li class="flex gap-x-3">
            <svg class="h-6 w-5 flex-none text-indigo-600" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true" data-slot="icon">
            ...
            Tersedianya Layanan Pendidikan Inklusi yang unggul dan adaptif          
          </li>
          <li class="flex gap-x-3">
            <svg class="h-6 w-5 flex-none text-indigo-600" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true" data-slot="icon">
              <path fill-rule="evenodd" d="M16.704 4.153a.75.75 0 0 1 .143 1.052l-8 10.5a.75.75 0 0 1-1.127.075l-4.5-4.5a.75.75 0 0 1 1.06-1.06l3.894 3.893 7.48-9.817a.75.75 0 0 1 1.05-.143Z" clip-rule="evenodd" />
            </svg>
            Terciptanya mahasiswa disabilitas technopreneur yang mandiri
          </li>
          <li class="flex gap-x-3">
            <svg class="h-6 w-5 flex-none text-indigo-600" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true" data-slot="icon">
              <path fill-rule="evenodd" d="M16.704 4.153a.75.75 0 0 1 .143 1.052l-8 10.5a.75.75 0 0 1-1.127.075l-4.5-4.5a.75.75 0 0 1 1.06-1.06l3.894 3.893 7.48-9.817a.75.75 0 0 1 1.05-.143Z" clip-rule="evenodd" />
            </svg>
            Terwujudnya layanan disabilitas yang Islami, inklusif dan berkemajuan di lingkungan kampus          
          </li>
          <li class="flex gap-x-3">
            <svg class="h-6 w-5 flex-none text-indigo-600" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true" data-slot="icon">
              <path fill-rule="evenodd" d="M16.704 4.153a.75.75 0 0 1 .143 1.052l-8 10.5a.75.75 0 0 1-1.127.075l-4.5-4.5a.75.75 0 0 1 1.06-1.06l3.894 3.893 7.48-9.817a.75.75 0 0 1 1.05-.143Z" clip-rule="evenodd" />
            </svg>
            Terbangunnya jejaring Kerjasama dengan berbagai pihak untuk meningkatkan kualitas layanan disabilitas
          </li>
        </ul>
      </div>
